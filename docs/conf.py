...
# -*- coding: utf-8 -*-
#
# cdp_scrapers documentation build configuration file, created by
...
release = cdp_scrapers.__version__
...
htmlhelp_basename = "cdp_scrapersdoc"
