...
install:
	pip install -e '.[lint,test,docs,dev,all_cities]'
...
# run tests
test:
	pytest --cov-report xml --cov-report html --cov=cdp_scrapers cdp_scrapers/tests
...
generate-docs:
	rm -f docs/cdp_scrapers*.rst
	rm -f docs/modules.rst
	sphinx-apidoc -o docs cdp_scrapers **/tests
